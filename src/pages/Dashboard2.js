        ...
        <div className="row">
            ...
            <div className="col-md-8">
                                ...
                                <div className="direct-chat-messages">
                                    ...
                                    <div className="direct-chat-msg">
                                        <div className="direct-chat-infos clearfix">
                                            <span className="direct-chat-name float-left">Alexander
                                                Pierce</span>
                                            <span className="direct-chat-timestamp float-right">23 Jan 2:00
                                                pm</span>
                                        </div>

                                        <img className="direct-chat-img" src="assets/dist/img/user1-128x128.jpg"
                                            alt=""/>
                                    ...
                                    <div className="direct-chat-msg right">
                                        <div className="direct-chat-infos clearfix">
                                            ...
                                            <span className="direct-chat-timestamp float-left">23 Jan 2:05
                                                pm</span>
                                        </div>

                                        <img className="direct-chat-img" src="assets/dist/img/user3-128x128.jpg"
                                            alt=""/>
                                    ...
                                    <div className="direct-chat-msg">
                                        <div className="direct-chat-infos clearfix">
                                            <span className="direct-chat-name float-left">Alexander
                                                Pierce</span>
                                            <span className="direct-chat-timestamp float-right">23 Jan 5:37
                                                pm</span>
                                        </div>
                                    ...
                                    <div className="direct-chat-msg right">
                                        <div className="direct-chat-infos clearfix">
                                            <span className="direct-chat-name float-right">Sarah Bullock</span>
                                            <span className="direct-chat-timestamp float-left">23 Jan 6:10
                                                pm</span>
                                        </div>
                                        ...
                                        <li>
                                            <Link to="#">
                                                ...
                                                <div className="contacts-list-info">
                                                    ...
                                                    <span className="contacts-list-msg">I will be waiting
                                                        for...</span>
                                                </div>
                                        ...
                                        <li>
                                            <Link to="#">
                                                ...
                                                <div className="contacts-list-info">
                                                    ...
                                                    <span className="contacts-list-msg">I'll call you back
                                                        at...</span>
                                                </div>
                                        ...
                                        <li>
                                            <Link to="#">
                                                ...
                                                <div className="contacts-list-info">
                                                    ...
                                                    <span className="contacts-list-msg">Where is your
                                                        new...</span>
                                                </div>
                                        ...
                                        <li>
                                            <Link to="#">
                                                ...
                                                <div className="contacts-list-info">
                                                    ...
                                                    <span className="contacts-list-msg">Can I take a look
                                                        at...</span>
                                                </div>
                                        ...
                                        <li>
                                            <Link to="#">
                                                ...
                                                <div className="contacts-list-info">
                                                    ...
                                                    <span className="contacts-list-msg">Never mind I
                                                        found...</span>
                                                </div>
                        ...
                        <div className="card">
                            ...
                            <div className="card-body p-0">
                                <ul className="users-list clearfix">
                                    <li>
                                        <img src="assets/dist/img/user1-128x128.jpg" alt=""/>
                                        <Link className="users-list-name" to="#">Alexander Pierce</Link>
                                        <span className="users-list-date">Today</span>
                                    </li>
                                    <li>
                                        <img src="assets/dist/img/user8-128x128.jpg" alt=""/>
                                        <Link className="users-list-name" to="#">Norman</Link>
                                        <span className="users-list-date">Yesterday</span>
                                    </li>
                                    <li>
                                        <img src="assets/dist/img/user7-128x128.jpg" alt=""/>
                                        <Link className="users-list-name" to="#">Jane</Link>
                                        <span className="users-list-date">12 Jan</span>
                                    </li>
                                    <li>
                                        <img src="assets/dist/img/user6-128x128.jpg" alt=""/>
                                        <Link className="users-list-name" to="#">John</Link>
                                        <span className="users-list-date">12 Jan</span>
                                    </li>
                                    <li>
                                        <img src="assets/dist/img/user2-160x160.jpg" alt=""/>
                                        <Link className="users-list-name" to="#">Alexander</Link>
                                        <span className="users-list-date">13 Jan</span>
                                    </li>
                                    <li>
                                        <img src="assets/dist/img/user5-128x128.jpg" alt=""/>
                                        <Link className="users-list-name" to="#">Sarah</Link>
                                        <span className="users-list-date">14 Jan</span>
                                    </li>
                                    <li>
                                        <img src="assets/dist/img/user4-128x128.jpg" alt=""/>
                                        <Link className="users-list-name" to="#">Nora</Link>
                                        <span className="users-list-date">15 Jan</span>
                                    </li>
                                    <li>
                                        <img src="assets/dist/img/user3-128x128.jpg" alt=""/>
                                        <Link className="users-list-name" to="#">Nadia</Link>
                                        <span className="users-list-date">15 Jan</span>
                                    </li>
                                </ul>
                ...
                <div className="card">
                        ...
                        <div className="table-responsive">
                            <table className="table m-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><Link to="pages/examples/invoice.html">OR1848</Link></td>
                                    ...
                                    <tr>
                                        <td><Link to="pages/examples/invoice.html">OR7429</Link></td>
                                        <td>iPhone 6 Plus</td>
                    ...
                    <div className="card-footer clearfix">
                        <Link to="void(0)" className="btn btn-sm btn-info float-left">Place New
                            Order</Link>
                        <Link to="void(0)" className="btn btn-sm btn-secondary float-right">View All
                            Orders</Link>
                    </div>
            ...
            <div className="col-md-4">
                ...
                <div className="card">
                        ...
                        <ul className="products-list product-list-in-card pl-2 pr-2">
                            <li className="item">
                                <div className="product-img">
                                    <img src="assets/dist/img/default-150x150.png" alt=""
                                        className="img-size-50"/>
                                </div>
                                <div className="product-info">
                                    <Link to="void(0)" className="product-title">Samsung TV
                                        <span className="badge badge-warning float-right">$1800</span></Link>
                            ...
                            <li className="item">
                                ...
                                <div className="product-info">
                                    <Link to="void(0)" className="product-title">Bicycle
                                        <span className="badge badge-info float-right">$700</span></Link>
                                    <span className="product-description">
                            ...
                            <li className="item">
                                ...
                                <div className="product-info">
                                    <Link to="void(0)" className="product-title">
                            ...
                            <li className="item">
                                ...
                                <div className="product-info">
                                    <Link to="void(0)" className="product-title">PlayStation 4
                                        <span className="badge badge-success float-right">$399</span></Link>
                                    <span className="product-description">
                    ...
                    <div className="card-footer text-center">
                        <Link to="void(0)" className="uppercase">View All Products</Link>
                    </div>
