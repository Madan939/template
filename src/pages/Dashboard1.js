              ...
              <div className="card-body">
                ...
                <div className="direct-chat-messages">
                  ...
                  <div className="direct-chat-msg">
                    ...
                    <img className="direct-chat-img" src="assets/dist/img/user1-128x128.jpg" alt=''/>
                  ...
                  <div className="direct-chat-msg right">
                    ...
                    <img className="direct-chat-img" src="assets/dist/img/user3-128x128.jpg" alt=''/>
                ...
                <div className="direct-chat-contacts">
                  <ul className="contacts-list">
                    <li>
                      <Link to="#">
                        <img className="contacts-list-img" src="assets/dist/img/user1-128x128.jpg" alt=""/>
                    ...
                    <li>
                      <Link to="#">
                        <img className="contacts-list-img" src="assets/dist/img/user7-128x128.jpg" alt=""/>
                        <div className="contacts-list-info">
                          <span className="contacts-list-name">
                            Sarah Doe
                    ...
                    <li>
                      <Link to="#">
                        <img className="contacts-list-img" src="assets/dist/img/user3-128x128.jpg" alt=""/>
                        <div className="contacts-list-info">
                          <span className="contacts-list-name">
                            Nadia Jolie
                    ...
                    <li>
                      <Link to="#">
                        <img className="contacts-list-img" src="assets/dist/img/user5-128x128.jpg" alt=""/>
                        <div className="contacts-list-info">
                          <span className="contacts-list-name">
                            Nora S. Vans
                    ...
                    <li>
                      <Link to="#">
                        <img className="contacts-list-img" src="assets/dist/img/user6-128x128.jpg" alt=""/>
                        <div className="contacts-list-info">
                          <span className="contacts-list-name">
                            John K.
                    ...
                    <li>
                      <Link to="#">
                        <img className="contacts-list-img" src="assets/dist/img/user8-128x128.jpg" alt=""/>
                        <div className="contacts-list-info">
                          <span className="contacts-list-name">
                            Kenneth M.
              ...
              <div className="card-header">
                ...
                <div className="card-tools">
                  <ul className="pagination pagination-sm">
                    <li className="page-item"><Link to="#" className="page-link">&laquo;</Link></li>
                    <li className="page-item"><Link to="#" className="page-link">1</Link></li>
                    <li className="page-item"><Link to="#" className="page-link">2</Link></li>
                    <li className="page-item"><Link to="#" className="page-link">3</Link></li>
                    <li className="page-item"><Link to="#" className="page-link">&raquo;</Link></li>
                  </ul>
                </div>
              </div>
